...
export function PortalShell({ children, isAdmin, section, showAdminNavigation = false, showUserNavigation = false, userName, userImage }: {
  children: ReactNode;
  isAdmin: boolean;
  section?: string;
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-[var(--color-bg)]">
      <PortalHeader isAdmin={isAdmin} section={section} userName={userName} userImage={userImage} />
